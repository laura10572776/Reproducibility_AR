...
ABSL_FLAG(double, temperature_drop, 20, // Smaller than AZ due to short games.
...
ABSL_FLAG(int, max_simulations, 50, "How many simulations to run.");
...
int main(int argc, char **argv)
{
  ...
  open_spiel::algorithms::torch_az_opp::AlphaZeroConfig config;
