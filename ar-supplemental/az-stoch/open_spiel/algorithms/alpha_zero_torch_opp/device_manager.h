...
#ifndef OPEN_SPIEL_ALGORITHMS_ALPHA_ZERO_TORCH_OPP_DEVICE_MANAGER_H_
#define OPEN_SPIEL_ALGORITHMS_ALPHA_ZERO_TORCH_OPP_DEVICE_MANAGER_H_
  ...
  namespace algorithms
  {
    namespace torch_az_opp
    {
      ...
      public:
        ...
        void AddDevice(VPNetModel model)
        { // Not thread safe.
